...
export const Item = () => {
  return (
    <>
      <div className="flex w-[280px] items-center justify-between rounded-md border-2 border-dark-orange bg-gray p-3">
        <p className="w-4/6 text-lg font-medium text-white">Shoes</p>
        <div className="flex w-2/6 items-center justify-end">
          <input
            className="mr-2 h-7 w-7 cursor-pointer accent-light-orange"
            type="checkbox"
          />
          <button className="cursor-pointer rounded border-2 border-dark-orange bg-black p-2 text-light-orange">
            <RxCross2 size={15} />
          </button>
        </div>
      </div>
